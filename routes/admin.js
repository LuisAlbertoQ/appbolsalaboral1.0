...
router.get('/oferta_laboral-add', function (req, res, next) {
  dbConn.query('SELECT u.usu_nombre_razon_social,e.em_id FROM oferta_laboral ol, empresas e , usuario u WHERE e.em_id=ol.ol_em_id AND u.usu_id=e.em_usu_id GROUP BY e.em_id', function (err, rows) {
